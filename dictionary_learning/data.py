...
from dictionary_learning.types import Samples
...
class DatasetConfig(BaseModel):
    ...
    Typically 'input_ids' for datasets stored with dictionary_learning/scripts/upload_hf_dataset.py, or "tokens"
...
def create_data_loader(
    ...
    # see dictionary_learning.scripts.upload_hf_dataset.TextDataset.__init__
