...
`dictionary_learning/scripts/train_mnist/run_train_mnist.py` script.
...
from dictionary_learning.models.mlp import MLP, MLPMod
from dictionary_learning.settings import REPO_ROOT
from dictionary_learning.types import RootPath
from dictionary_learning.utils import load_config, save_module, set_seed
