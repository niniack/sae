...
from dictionary_learning.hooks import CacheActs, SAEActs, cache_hook, sae_hook
from dictionary_learning.loader import load_tlens_model
from dictionary_learning.models.sparsifiers import SAE
from dictionary_learning.utils import filter_names, get_hook_shapes
...
class SAETransformer(nn.Module):
    ...
    def from_local_path(
        ...
        dictionary_learning/scripts/train_tlens_saes/run_train_tlens_saes.py.Config class for type
